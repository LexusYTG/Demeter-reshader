...
📘 **[Compilar Demeter →](BUILDINGES.md)**
...
· Poco C65 / Redmi 13C (Helio G85, 4 GB RAM en versión básica, Android 13)
...
Contamos con un amplio catálogo de shaders en la store, listos para descargar y probar.
